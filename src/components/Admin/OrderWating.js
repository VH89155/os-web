...
import OrderID from './OrderIDWatting';
...
const data =data1.filter((item) => item.status=== false && item.cancel === false) 
...
const columns = [
  ...
  // },
  {
    ...
    render: (_,record) =>{
      ...
      else return  <Progress type="circle" percent={100} width={60} status="normal" format={() => 'Wating'}/>
