...
import { useState } from "react";
  ...
  const OrderID = (props) => {
    ...
    const order = useSelector((state) => state.orderID?.ordersID);
    const [showDelete,setShowDeleted] =useState(true)
    ...
    // if(order?.status === false && order?.cancel ===false) {
      ...
      <>
        ...
        />
            ...
            </Col> */}
            {
               ...
               !order.status? <> <Col span={12} style={{textAlign:"center"}}>
            ...
            {/* {
                ...
                !showDelete? <> <Col span={12} style={{textAlign:"center"}}>
                <Button type="primary" onClick={()=>handleCancel()} danger>
                 Delete
                </Button>
              </Col></>
